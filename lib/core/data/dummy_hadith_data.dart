import 'package:noor_verse/core/models/hadith_model.dart';

final List<Hadith> dummyHadithList = [
  Hadith(
  ...
  Hadith(
    ...
    englishTranslation: 'The religion is sincere advice.',
    reference: 'Sahih Muslim 55',
    bookName: 'Sahih Muslim',
    narrator: 'Narrated by Tamim ad-Dari (RA)',
  ),
  Hadith(
